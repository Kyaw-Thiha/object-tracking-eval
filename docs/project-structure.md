...
- `src/data/mmtrack_datasets/`: MMDet/MMTrack-registered dataset classes (optional/legacy usage).
...
- `src/data/mmtrack_datasets/`: MMDet/MMTrack-registered datasets (optional/legacy usage). These classes extend MMDet/MMTrack base datasets and add covariance-aware formatting/evaluation.
