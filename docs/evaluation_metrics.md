...
$$
TPA(c) = \{p \mid p \in TP,\ \text{gtID}(p) = \text{gtID}(c) \wedge \text{prID}(p) = \text{prID}(c)\}
$$
...
$$
FPA(c) = \{p \mid p \in FP,\ \text{gtID}(p) = \text{gtID}(c) \wedge \text{prID}(p) \neq \text{prID}(c)\} \cup \{p \mid p \in FP,\ \text{gtID}(p) = \text{gtID}(c)\}
$$
...
$$
FNA(c) = \{p \mid p \in FN,\ \text{gtID}(p) \neq \text{gtID}(c) \wedge \text{prID}(p) = \text{prID}(c)\} \cup \{p \mid p \in FN,\ \text{prID}(p) = \text{prID}(c)\}
$$
